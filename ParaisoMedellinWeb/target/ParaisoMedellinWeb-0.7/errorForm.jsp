...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Error al agregar estación</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="" name="keywords">
        <meta content="" name="description">

        <!-- Favicon -->
        <link href="img/logos/favIconParaisoWeb@404.png" rel="icon">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
            ...
            <h2 style="margin-top: 7px; margin-left: 10px" class="text-paraisocolor">| Oops!</h2>
    ...
    <div class="container-xxl py-4 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <i class="bi bi-exclamation-triangle display-1 text-primary" style="font-size: 8rem;"></i>
                    <h1 style="margin-bottom: 3px">Hubo un error al crear la estación.</h1>
                    <p class="mb-3"><br><br>- La línea o estación ya existe, o alguno de sus campos ya han sido tomados.<br>- Faltaron campos por rellenar en el formulario.
                    </p>
                    <a class="btn btn-primary rounded-pill py-3 px-5" href="${pageContext.request.contextPath}/StationServlet?accion=admin"">Regresar al administrador de estaciones</a>
                </div>
            </div>
        </div>
    </div>
