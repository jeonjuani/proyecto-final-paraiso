...
<head>
    <meta charset="utf-8">
    <title>Paraíso /Medellín/ - Administrador</title>
...
<body>
    ...
    <!-- Start Admin Start -->
    <div class="containerAdmin py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <div class="row justify-content-center">
                <div class="col-lg-4"> <!-- Se divide en tres columnas iguales: col-lg-4 -->
                    <i class="bi bi-gear-wide-connected display-1 text-primary" style="font-size: 8rem;"></i>
                    <h1 class="display-1 text-dark">Inspírate</h1>
                    <h1 class="mb-4">Editar la experiencia</h1>
                    <p class="mb-4">Por el Paraíso que queremos</p>
                    <a class="btn btn-danger rounded-pill py-3 px-5" href="https://www.roblox.com/games/8246576295">Ir a Roblox</a>
                </div>
                <div class="col-lg-4"> <!-- Se divide en tres columnas iguales: col-lg-4 -->
                    <i class="bi bi-plus-circle-fill display-1 text-primary" style="font-size: 8rem;"></i>
                    <h1 class="display-1 text-dark">Impacta</h1>
                    <h1 class="mb-4">Líneas</h1>
                    <p class="mb-4">¿Más líneas? ¡Qué emoción!</p>
                    <a class="btn btn-danger rounded-pill py-3 px-5" href="adminLines.jsp">Administrar líneas</a>
                </div>
                <div class="col-lg-4"> <!-- Se divide en tres columnas iguales: col-lg-4 -->
                    <i class="bi bi-stop-circle-fill display-1 text-primary" style="font-size: 8rem;"></i>
                    <h1 class="display-1 text-dark">Expande</h1>
                    <h1 class="mb-4">Estaciones</h1>
                    <p class="mb-4">¿Pues quiénes más hacen interesante una línea?</p>
                    <a class="btn btn-danger rounded-pill py-3 px-5" href="${pageContext.request.contextPath}/StationServlet?accion=admin">Administrar estaciones</a>
                </div>
            </div>
        </div>
    </div>    
