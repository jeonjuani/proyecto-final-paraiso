...
<html lang="en">
    ...
    <div class="container-xxl mb-5">
        <h1 class="text-paraisocolor" style="margin-top: 10px">Líneas <span class="h2 text-dark">| Operadas por el Sistema Integrado de Transporte de Paraíso</span></h1>
        ...
        <c:forEach var="line" items="${lines}">
            <li class="list-group-item">
                <div class="row align-items-center">
                    <div class="col-md-1">
                        <span class="label label-info h4 my-0">${line.id_line}</span>
                    </div>
                    <div class="col-md-11">
                        <h5 class="mb-1">${line.official_name}</h5>
                        <p class="mb-0">Porcentaje de construcción: ${line.status_percentage}</p>
                        <p class="mb-0">Longitud (km): ${line.length_in_km}</p>
                        <p class="mb-0">Tipo: ${line.type}</p>
                        <p class="mb-0">Cantidad de estaciones: ${line.amount_of_stations}</p>
                    </div>
                </div>
            </li>
        </c:forEach>
